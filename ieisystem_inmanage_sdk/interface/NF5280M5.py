...
from ieisystem_inmanage_sdk.interface.CommonM5 import CommonM5
import sys
import os
import re
...
import random
import time
from ieisystem_inmanage_sdk.interface.Base import Base
    ...
    def getProgressAndDown(self, client, args):
        ...
        while True:
            ...
            if process_res == {}:
                    ...
                    if "FileExistFlag" in data and "FileName" in data:
                        ...
                        if data["FileName"] != "":
                            ...
                            if download_res == {}:
                                bmcres.State("Failure")
                                bmcres.Message(
                                    ['Failed to call BMC interface ' + args.logpath + ', response is none'])
                ...
                error_info = "cannot check one key log status" + \
                    str(process_res)
                error_count = error_count + 1
                continue
        return bmcres
