...
import time
import platform
from ieisystem_inmanage_sdk.util import RegularCheckUtil
from ieisystem_inmanage_sdk.command import RestFunc
from ieisystem_inmanage_sdk.interface.ResEntity import ResultBean
...
def dns(client, bak_path):
    ...
    if dns_info.get('code') == 0 and dns_info.get('data') is not None:
        ...
        data['dns_iface'] = DNSJson['dns_iface']
        data['dns_manual'] = DNSJson['dns_manual']
        data['dns_priority'] = DNSJson['dns_priority']
        data['dns_server1'] = DNSJson['dns_server1']
        data['dns_server2'] = DNSJson['dns_server2']
        data['dns_server3'] = DNSJson['dns_server3']
        data['dns_status'] = DNSJson['dns_status']
        data['domain_iface'] = DNSJson['domain_iface']
        data['domain_manual'] = DNSJson['domain_manual']
        data['domain_name'] = DNSJson['domain_name']
        data['host_cfg'] = DNSJson['host_cfg']
        data['host_name'] = DNSJson['host_name']
