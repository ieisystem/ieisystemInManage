...
import os
import re
from ieisystem_inmanage_sdk.util import RegularCheckUtil, RequestClient, fileUtil, configUtil
from ieisystem_inmanage_sdk.command import RestFunc, IpmiFunc, RedfishFunc
from ieisystem_inmanage_sdk.interface.Base import (Base, ascii2hex, hexReverse)
from ieisystem_inmanage_sdk.interface.CommonM5 import (CommonM5, judgeAttInList, PCI_IDS_LIST, restore_bios)
from ieisystem_inmanage_sdk.interface.ResEntity import (
    ResultBean,
    CapabilitiesBean,
    CPUBean,
    Cpu,
